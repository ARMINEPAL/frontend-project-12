    ...
    <Dropdown.Menu>
      ...
      >
        {t('buttons.rename')}
            ...
            <span className="text-muted"> {t('chatPage.messagesCount.count', { count: messagesCount })}</span>
            </div>
                <div id="messages-box" className="fchat-messages overflow-auto px-5 ">
                  {messages
                ...
                <form className="py-1 border rounded-2" onSubmit={handleSubmit}>
                  <div className="input-group has-validation">
                    ...
                    >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20" fill="currentColor" class="bi bi-arrow-right-square"><path fill-rule="evenodd" d="M15 2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1zM0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm4.5 5.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"></path></svg>
